...
import { NonVotersTool, NonVotersToolProps } from './non-voters-tool/non-voters-tool';
...
export const NonVoters: FC<NonVotersProps> = (props): JSX.Element => (
  <Layout { ...props.layout }>
    ...
    <p>This tool allows users to evaluate the effects of hypothetical situations where non-voters had instead chosen to vote.</p>
